	<?php
		...
		$qGetRecordCount = mysql_fetch_array(mysql_query("select count(id) as id from kelompok")); 
...
<!-- panel -->
<div class="panel">
	<div class="panel-heading">Data Kelompok</div>
		...
		<!-- pencarian -->
		 <table class="filter" border="0">
		  ...
		  <table class="paging" style="margin-left:3px" border="0"><tr>
			  <td>
				  <input type="image" src="../../images/button/new.gif" title="buat kelompok baru" onClick="create_new();">&nbsp;
			  </td>
			  <td align="right">Page:    
		...
		<table class="table-hover">
			...
			<?php if($count==0){
				...
				<tr>
					...
					<td><?php echo $row['no_rubrik']; ?></td>
					<td>
						<a href="?q=kelompok-edit&id=<?php echo $row['id']; ?>"><img src="../../images/icon/edit.gif" title="Edit"></a>&nbsp;
						 <?php if($_SESSION['level']== 2){ ?>
						<a href="?q=kelompok-del&id=<?php echo $row['id']; ?>" onClick="return confirm('Are You Sure Want To Delete')"><img src="../../images/icon/delete.gif" title="Delete"></a>
						 <?php } ?>	
					</td>
				</tr>
			<?php }} ?>	
...
function is_reload() {	
	document.frm.action = 'home.php?q=kelompok-manage'
	document.frm.method = 'post';
	document.frm.submit();
}

function create_new() {	
	document.frm.action = 'home.php?q=kelompok-add'
	document.frm.method = 'post';
	document.frm.submit();
}

function desc(field,sortir){
		document.frm.action = 'home.php?q=kelompok-manage&SortOrder=' +sortir+ '&SortField=' +field
	document.frm.method = 'post';
	document.frm.submit();
