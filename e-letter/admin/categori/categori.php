	<?php
		...
		$qGetRecordCount = mysql_fetch_array(mysql_query("select count(id) as id from categori")); 
...
<!-- panel -->
<div class="panel">
	<div class="panel-heading">Kategori Surat</div>
		...
		<table class="table-hover">
			...
			<?php if($count==0){
				...
				<tr>
					...
					<td width="750px"><?php echo $row['note']; ?></td>
					<td>
						<a href="?q=categori-edit&id=<?php echo $row['id']; ?>"><img src="../../images/icon/edit.gif" title="Edit"></a>&nbsp;
						 <?php if($_SESSION['level']== 2){ ?>
						<a href="?q=categori-del&id=<?php echo $row['id']; ?>" onClick="return confirm('Are You Sure Want To Delete')"><img src="../../images/icon/delete.gif" title="Delete"></a>
						 <?php } ?>	
					</td>
				</tr>
			<?php }} ?>	
...
function is_reload() {	
	document.frm.action = 'home.php?q=categori-manage'
	document.frm.method = 'post';
	document.frm.submit();
}

function create_new() {	
	document.frm.action = 'home.php?q=categori-add'
	document.frm.method = 'post';
	document.frm.submit();
}

function desc(field,sortir){
		document.frm.action = 'home.php?q=categori-manage&SortOrder=' +sortir+ '&SortField=' +field
	document.frm.method = 'post';
	document.frm.submit();
